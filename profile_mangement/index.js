...
const handleWagerIncrease = (async(user_id, bet_amount, crypto)=>{
     ...
     handleAffiliateCommission(user_id,bet_amount , crypto)
      if(total_wagered >= 1 ){
        ...
        next_hit = 100
       prev_level_up === 1 && handleProgressPercentage(1, next_hit, total_wagered, user_id)
        }
        if( total_wagered >= 100 ){
                next_hit = 200
                prev_level_up < 2 &&  handelLevelups(2, user_id)
               prev_level_up === 2 && handleProgressPercentage(100, next_hit, total_wagered, user_id)
        }
        if( total_wagered >= 200 ){
                next_hit = 1000
            prev_level_up < 3 &&   handelLevelups(3, user_id)
           prev_level_up ===3 && handleProgressPercentage(200, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 1000 ){
                next_hit = 2000
               prev_level_up === 4 && handleProgressPercentage(1000, next_hit, total_wagered, user_id)
            prev_level_up < 4 &&  handleAffiliateRewards(4, user_id)
            prev_level_up < 4 &&  handelLevelups(4, user_id)
       }
        if( total_wagered >= 2000 ){
                next_hit = 3000
               prev_level_up === 5 && handleProgressPercentage(2000, next_hit, total_wagered, user_id)
            prev_level_up < 5 &&  handleAffiliateRewards(5, user_id)
            prev_level_up < 5 &&  handelLevelups(5, user_id)
       }
        if( total_wagered >= 3000 ){
                next_hit = 4000
               prev_level_up === 6 && handleProgressPercentage(3000, next_hit, total_wagered, user_id)
            prev_level_up < 6 &&  handleAffiliateRewards(6, user_id)
            prev_level_up < 6 &&  handelLevelups(6, user_id)
        }
        if( total_wagered >= 4000 ){
         next_hit = 5000
        prev_level_up === 7 && handleProgressPercentage(4000, next_hit, total_wagered, user_id)
            prev_level_up < 7 &&  handleAffiliateRewards(7, user_id)
            prev_level_up < 7 &&  handelLevelups(7, user_id)
       }
        if( total_wagered >= 5000 ){
                next_hit = 7000
               prev_level_up === 8 && handleProgressPercentage(5000, next_hit, total_wagered, user_id)
      ...
      if( total_wagered >= 49000 ){
        next_hit = 59000
         ...
         prev_level_up === 22 && handleProgressPercentage(49000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 59000 ){
                next_hit = 69000
             prev_level_up < 23 &&   handleAffiliateRewards(23, user_id)
             prev_level_up < 23 &&   handelLevelups(23, user_id)
            prev_level_up === 23 && handleProgressPercentage(59000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 69000 ){
                next_hit = 79000
             prev_level_up < 24 &&   handleAffiliateRewards(24, user_id)
             prev_level_up < 24 &&   handelLevelups(24, user_id)
            prev_level_up === 24 && handleProgressPercentage(69000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 79000 ){
                next_hit = 89000
             prev_level_up < 25 &&   handleAffiliateRewards(25, user_id)
             prev_level_up < 25 &&   handelLevelups(25, user_id)
            prev_level_up === 25 && handleProgressPercentage(79000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 89000 ){
                next_hit = 99000
             prev_level_up < 26 &&   handleAffiliateRewards(26, user_id)
             prev_level_up < 26 &&   handelLevelups(26, user_id)
            prev_level_up === 26 && handleProgressPercentage(89000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 99000 ){
                next_hit = 109000
              prev_level_up < 27 &&   handleAffiliateRewards(27, user_id)
              prev_level_up < 27 &&   handelLevelups(27, user_id)
             prev_level_up === 27 && handleProgressPercentage(99000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 109000 ){
                next_hit = 119000
              prev_level_up < 28 &&   handleAffiliateRewards(28, user_id)
              prev_level_up < 28 &&   handelLevelups(28, user_id)
             prev_level_up === 28 && handleProgressPercentage(109000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 119000 ){
                next_hit = 129000
              prev_level_up < 29 &&   handleAffiliateRewards(29, user_id)
              prev_level_up < 29 &&   handelLevelups(29, user_id)
             prev_level_up === 29 && handleProgressPercentage(119000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 129000 ){
                next_hit = 153000
              prev_level_up < 30 &&   handleAffiliateRewards(30, user_id)
              prev_level_up < 30 &&   handelLevelups(30, user_id)
             prev_level_up === 30 && handleProgressPercentage(129000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 153000 ){
                next_hit = 177000
              prev_level_up < 31 &&   handleAffiliateRewards(31, user_id)
              prev_level_up < 31 &&   handelLevelups(31, user_id)
             prev_level_up === 31 && handleProgressPercentage(153000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 177000 ){
                next_hit = 201000
              prev_level_up < 32 &&   handelLevelups(32, user_id)
              prev_level_up < 32 &&   handleAffiliateRewards(32, user_id)
             prev_level_up === 32 && handleProgressPercentage(177000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 201000 ){
                next_hit = 225000
              prev_level_up < 33 &&   handleAffiliateRewards(33, user_id)
              prev_level_up < 33 &&   handelLevelups(33, user_id)
             prev_level_up === 33 && handleProgressPercentage(201000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 225000 ){
                next_hit = 249000
              prev_level_up < 34 &&   handleAffiliateRewards(34, user_id)
              prev_level_up < 34 &&   handelLevelups(34, user_id)
             prev_level_up === 34 && handleProgressPercentage(225000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 249000 ){
                next_hit = 273000
              prev_level_up < 35 &&   handleAffiliateRewards(35, user_id)
              prev_level_up < 35 &&   handelLevelups(35, user_id)
             prev_level_up === 35 && handleProgressPercentage(249000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 273000 ){
                next_hit = 297000
              prev_level_up < 36 &&   handleAffiliateRewards(36, user_id)
              prev_level_up < 36 &&   handelLevelups(36, user_id)
             prev_level_up === 36 && handleProgressPercentage(273000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 297000 ){
                next_hit = 321000
              prev_level_up < 37 &&   handleAffiliateRewards(37, user_id)
              prev_level_up < 37 &&   handelLevelups(37, user_id)
             prev_level_up === 37 && handleProgressPercentage(297000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 321000 ){
                next_hit = 377000
              prev_level_up < 38 &&   handleAffiliateRewards(38, user_id)
              prev_level_up < 38 &&   handelLevelups(38, user_id)
             prev_level_up === 38 && handleProgressPercentage(321000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 377000 ){
                next_hit = 433000
              prev_level_up < 39 &&   handelLevelups(39, user_id)
             prev_level_up === 39 && handleProgressPercentage(377000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 433000 ){
                next_hit = 489000
              prev_level_up < 40 &&   handelLevelups(40, user_id)
             prev_level_up === 40 && handleProgressPercentage(433000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 489000 ){
                next_hit = 545000
              prev_level_up < 41 &&   handelLevelups(41, user_id)
             prev_level_up === 41 && handleProgressPercentage(489000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 545000 ){
                next_hit = 601000
              prev_level_up < 42 &&   handelLevelups(42, user_id)
             prev_level_up === 42 && handleProgressPercentage(545000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 601000 ){
                next_hit = 657000
              prev_level_up < 43 &&   handelLevelups(43, user_id)
             prev_level_up === 43 && handleProgressPercentage(601000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 657000 ){
                next_hit = 713000
              prev_level_up < 44 &&   handelLevelups(44, user_id)
             prev_level_up === 44 && handleProgressPercentage(657000, next_hit, total_wagered, user_id)
       }     
        if( total_wagered >= 713000 ){
                next_hit = 769000
              prev_level_up < 45 &&   handelLevelups(45, user_id)
             prev_level_up === 45 && handleProgressPercentage(713000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 769000 ){
                next_hit = 897000
              prev_level_up < 46 &&   handelLevelups(46, user_id)
             prev_level_up === 46 && handleProgressPercentage(769000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 897000 ){
                next_hit = 1025000
               prev_level_up < 47 &&   handelLevelups(47, user_id)
              prev_level_up === 47 && handleProgressPercentage(897000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 1025000 ){
                next_hit = 1153000
               prev_level_up < 48 &&   handelLevelups(48, user_id)
              prev_level_up === 48 && handleProgressPercentage(1025000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 1153000 ){
                next_hit = 1281000
               prev_level_up < 49 &&   handelLevelups(49, user_id)
              prev_level_up === 49 && handleProgressPercentage(1153000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 1281000 ){
                next_hit = 1409000
               prev_level_up < 50 &&   handelLevelups(50, user_id)
              prev_level_up === 50 && handleProgressPercentage(1281000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 1409000 ){
                next_hit = 1537000
               prev_level_up < 51 &&   handelLevelups(51, user_id)
              prev_level_up === 51 && handleProgressPercentage(1409000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 1537000 ){
                next_hit = 1665000
               prev_level_up < 52 &&   handelLevelups(52, user_id)
              prev_level_up === 52 && handleProgressPercentage(1537000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 1665000 ){
                next_hit = 1793000
               prev_level_up < 53 &&   handelLevelups(53, user_id)
              prev_level_up === 53 && handleProgressPercentage(1665000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 1793000 ){
                next_hit = 2081000
               prev_level_up < 54 &&   handelLevelups(54, user_id)
              prev_level_up === 54 && handleProgressPercentage(1793000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 2081000 ){
                next_hit = 2369000
               prev_level_up < 55 &&   handelLevelups(55, user_id)
              prev_level_up === 55 && handleProgressPercentage(2081000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 2369000 ){
                next_hit = 2657000
               prev_level_up < 56 &&   handelLevelups(56, user_id)
              prev_level_up === 56 && handleProgressPercentage(2369000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 2657000 ){
                next_hit = 2945000
               prev_level_up < 57 &&   handelLevelups(57, user_id)
              prev_level_up === 57 && handleProgressPercentage(2657000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 2945000 ){
                next_hit = 3233000
               prev_level_up < 58 &&   handelLevelups(58, user_id)
              prev_level_up === 58 && handleProgressPercentage(2945000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 3233000 ){
                next_hit = 3521000
               prev_level_up < 59 &&   handelLevelups(59, user_id)
              prev_level_up === 59 && handleProgressPercentage(3233000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 3521000 ){
                next_hit = 3809000
               prev_level_up < 60 &&   handelLevelups(60, user_id)
              prev_level_up === 60 && handleProgressPercentage(3521000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 3809000 ){
                next_hit = 4097000
               prev_level_up < 61 &&   handelLevelups(61, user_id)
              prev_level_up === 61 && handleProgressPercentage(3809000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 4097000 ){
                next_hit = 4737000
               prev_level_up < 62 &&   handelLevelups(62, user_id)
              prev_level_up === 62 && handleProgressPercentage(4097000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 4737000 ){
                next_hit = 5377000
               prev_level_up < 63 &&   handelLevelups(63, user_id)
              prev_level_up === 63 && handleProgressPercentage(4737000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 5377000 ){
                next_hit = 6017000
               prev_level_up < 64 &&   handelLevelups(64, user_id)
              prev_level_up === 64 && handleProgressPercentage(5377000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 6017000 ){
                next_hit = 6657000
               prev_level_up < 65 &&   handelLevelups(65, user_id)
              prev_level_up === 65 && handleProgressPercentage(6017000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 6657000 ){
                next_hit = 7297000
               prev_level_up < 66 &&   handelLevelups(66, user_id)
              prev_level_up === 66 && handleProgressPercentage(6657000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 7297000 ){
                next_hit = 7937000
              prev_level_up < 67 &&   handelLevelups(67, user_id)
             prev_level_up === 67 && handleProgressPercentage(7297000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 7937000 ){
                next_hit = 8577000
              prev_level_up < 68 &&   handelLevelups(68, user_id)
             prev_level_up === 68 && handleProgressPercentage(7937000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 8577000 ){
                next_hit = 9217000
              prev_level_up < 69 &&   handelLevelups(69, user_id)
             prev_level_up === 69 && handleProgressPercentage(8577000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 9217000 ){
                next_hit = 10625000
               prev_level_up < 70 &&   handelLevelups(70, user_id)
              prev_level_up === 70 && handleProgressPercentage(9217000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 10625000 ){
                next_hit = 12033000
                prev_level_up < 71 &&   handelLevelups(71, user_id)
               prev_level_up === 71 && handleProgressPercentage(10625000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 12033000 ){
                next_hit = 13441000
                prev_level_up < 72 &&   handelLevelups(72, user_id)
               prev_level_up === 72 && handleProgressPercentage(12033000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 13441000 ){
                next_hit = 14849000
                prev_level_up < 73 &&   handelLevelups(73, user_id)
               prev_level_up === 73 && handleProgressPercentage(13441000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 14849000 ){
                next_hit = 16257000
                prev_level_up < 74 &&   handelLevelups(74, user_id)
               prev_level_up === 74 && handleProgressPercentage(14849000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 16257000 ){
                next_hit = 17665000
                prev_level_up < 75 &&   handelLevelups(75, user_id)
               prev_level_up === 75 && handleProgressPercentage(16257000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 17665000 ){
                next_hit = 19073000
                prev_level_up < 76 &&   handelLevelups(76, user_id)
               prev_level_up === 76 && handleProgressPercentage(17665000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 19073000 ){
                next_hit = 20481000
                prev_level_up < 77 &&   handelLevelups(77, user_id)
               prev_level_up === 77 && handleProgressPercentage(19073000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 20481000 ){
                next_hit = 26625000
                prev_level_up < 78 &&   handelLevelups(78, user_id)
               prev_level_up === 78 && handleProgressPercentage(20481000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 26625000 ){
                next_hit = 29697000
                prev_level_up < 79 &&  handelLevelups(79, user_id)
               prev_level_up === 79 && handleProgressPercentage(26625000, next_hit, total_wagered, user_id)
       }
        if( total_wagered >= 29697000 ){
                next_hit = 32769000
                prev_level_up < 80 &&  handelLevelups(80, user_id)
               prev_level_up === 80 && handleProgressPercentage(29697000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 32769000 ){
                next_hit = 35841000
                prev_level_up < 81 &&  handelLevelups(81, user_id)
               prev_level_up === 81 && handleProgressPercentage(32769000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 35841000 ){
                next_hit = 38913000
                prev_level_up < 82 &&  handelLevelups(82, user_id)
               prev_level_up === 82 && handleProgressPercentage(35841000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 38913000 ){
                next_hit = 41985000
                prev_level_up < 83 &&  handelLevelups(83, user_id)
               prev_level_up === 83 && handleProgressPercentage(38913000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 41985000 ){
                next_hit = 45057000
                prev_level_up < 84 &&  handelLevelups(84, user_id)
               prev_level_up === 84 && handleProgressPercentage(41985000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 45057000 ){
                next_hit = 51713000
                prev_level_up < 85 &&  handelLevelups(85, user_id)
               prev_level_up === 85 && handleProgressPercentage(45057000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 51713000 ){
                next_hit = 58369000
                prev_level_up < 86 &&  handelLevelups(86, user_id)
               prev_level_up === 86 && handleProgressPercentage(51713000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 58369000 ){
                next_hit = 65025000
                prev_level_up < 87 &&  handelLevelups(87, user_id)
               prev_level_up === 87 && handleProgressPercentage(58369000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 65025000 ){
                next_hit = 71681000
                prev_level_up < 88 &&  handelLevelups(88, user_id)
               prev_level_up === 88 && handleProgressPercentage(65025000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 71681000 ){
                next_hit = 78337000
                prev_level_up < 89 &&  handelLevelups(89, user_id)
               prev_level_up === 89 && handleProgressPercentage(71681000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 78337000 ){
                next_hit = 84993000
                prev_level_up < 90 &&  handelLevelups(90, user_id)
               prev_level_up === 90 && handleProgressPercentage(78337000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 84993000 ){
                next_hit = 91649000
                prev_level_up < 91 &&  handelLevelups(91, user_id)
               prev_level_up === 91 && handleProgressPercentage(84993000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 91649000 ){
                next_hit = 98305000
                prev_level_up < 92 &&  handelLevelups(92, user_id)
               prev_level_up === 92 && handleProgressPercentage(91649000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 98305000 ){
                next_hit = 112641000
                  prev_level_up < 93 &&  handelLevelups(93, user_id)
                 prev_level_up === 93 && handleProgressPercentage(98305000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 112641000  ){
                next_hit = 126977000
                 prev_level_up < 94 &&  handelLevelups(94, user_id)
                prev_level_up === 94 && handleProgressPercentage(112641000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 126977000 ){
                next_hit = 141313000
                 prev_level_up < 95 &&  handelLevelups(95, user_id)
                prev_level_up === 95 && handleProgressPercentage(126977000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 141313000 ){
                next_hit = 155649000
                 prev_level_up < 96 &&  handelLevelups(96, user_id)
                prev_level_up === 96 && handleProgressPercentage(141313000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 155649000 ){
                next_hit = 78337000
                prev_level_up < 97 &&  handelLevelups(97, user_id)
               prev_level_up === 97 && handleProgressPercentage(155649000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 78337000 ){
                next_hit = 169985000
                 prev_level_up < 98 &&  handelLevelups(98, user_id)
                prev_level_up === 98 && handleProgressPercentage(78337000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 169985000 ){
                next_hit = 184321000
        prev_level_up < 99 &&  handelLevelups(99, user_id)
       prev_level_up === 99 && handleProgressPercentage(169985000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 184321000  ){
                next_hit = 198657000
           prev_level_up < 100 &&  handelLevelups(100, user_id)
          prev_level_up === 100 && handleProgressPercentage(184321000, next_hit, total_wagered, user_id)
       } 
        if( total_wagered >= 198657000 ){
                next_hit = 212993000
           prev_level_up < 101 &&  handelLevelups(101, user_id)
          prev_level_up === 101 && handleProgressPercentage(198657000, next_hit, total_wagered, user_id)
       } 
